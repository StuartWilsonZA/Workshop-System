         ...
         <br />
          <?php
            ...
            if (mysqli_connect_errno()) {
                ...
                if ($user['admin']=='yes'){
               // Search user from DB
                echo '<label for="namesearch">Search User:</label> ';  
                echo '<input class ="searchuser" type="text"   name="searchuser" value="" />'; 
                echo ' ';
                echo '<input class="submit" type="submit" name="searchuser" value="Search User">';
                echo '<br />';
                echo '<br />';  
                ...
                echo '<br />';
                echo '<input class="submit" type="submit" name="saveuser" value="Update User">';
                echo '<br />';
